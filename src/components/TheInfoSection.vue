...
<template>
  <div>
    ...
    <div class="relative mt-20 flex flex-col gap-24">
      ...
      <InfoCard icon="IconDetailedRecords">
        <template #heading>Detailed Records</template>
      ...
      <InfoCard icon="IconFullyCustomizable">
        <template #heading>Fully Customizable</template>
